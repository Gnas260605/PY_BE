...
> **Thời gian chạy:** 2026-08-24 13:07:26  
...
|:---|:---|:---:|:---|:---:|:---:|:---:|:---:|
| `ADM-01` | Kiểm tra Healthcheck hệ thống | `GET` | `/api/health` | `200` | `200` | 19.04ms | ✅ PASS |
| `ADM-02` | Đăng nhập ADMIN thành công | `POST` | `/api/login` | `200` | `200` | 220.65ms | ✅ PASS |
| `ADM-03` | Đăng nhập sai mật khẩu | `POST` | `/api/login` | `401` | `401` | 237.69ms | ✅ PASS |
| `ADM-04` | Lấy danh sách Users (Hỗ trợ lọc & tìm kiếm) | `GET` | `/api/users?role=USER&status=ACTIVE` | `200` | `200` | 15.94ms | ✅ PASS |
| `ADM-05` | Tạo User mới (user02) | `POST` | `/api/users` | `201` | `201` | 244.14ms | ✅ PASS |
| `ADM-06` | Tạo User trùng Username (Expect 409) | `POST` | `/api/users` | `409` | `409` | 11.25ms | ✅ PASS |
| `ADM-07` | Xem chi tiết User vừa tạo | `GET` | `/api/users/4` | `200` | `200` | 11.19ms | ✅ PASS |
| `ADM-08` | Cập nhật thông tin User | `PATCH` | `/api/users/4` | `200` | `200` | 17.88ms | ✅ PASS |
| `ADM-09` | Vô hiệu hóa User (INACTIVE) | `PATCH` | `/api/users/4/status` | `200` | `200` | 16.0ms | ✅ PASS |
| `ADM-10` | Đăng nhập bằng tài khoản INACTIVE (Expect 401) | `POST` | `/api/login` | `401` | `401` | 7.35ms | ✅ PASS |
| `ADM-11` | Kích hoạt lại User (ACTIVE) | `PATCH` | `/api/users/4/status` | `200` | `200` | 15.79ms | ✅ PASS |
| `ADM-12` | Thêm thiết bị mới (PC-002) | `POST` | `/api/devices` | `201` | `201` | 16.87ms | ✅ PASS |
| `ADM-13` | Thêm thiết bị trùng Mã (Expect 409) | `POST` | `/api/devices` | `409` | `409` | 13.77ms | ✅ PASS |
| `ADM-14` | Lấy danh sách thiết bị | `GET` | `/api/devices?status=ACTIVE&keyword=PC` | `200` | `200` | 14.53ms | ✅ PASS |
| `ADM-15` | Xem chi tiết thiết bị | `GET` | `/api/devices/4` | `200` | `200` | 16.47ms | ✅ PASS |
| `ADM-16` | Cập nhật thông tin & trạng thái thiết bị | `PATCH` | `/api/devices/4` | `200` | `200` | 22.37ms | ✅ PASS |
| `ADM-17` | Admin xem toàn bộ Ticket trong hệ thống | `GET` | `/api/tickets` | `200` | `200` | 11.31ms | ✅ PASS |
| `ADM-18` | Admin gán Kỹ thuật viên cho Ticket | `PATCH` | `/api/tickets/1/assign` | `200` | `200` | 16.64ms | ✅ PASS |
| `ADM-19` | Gán User không phải Kỹ thuật viên (Expect 400) | `PATCH` | `/api/tickets/1/assign` | `400` | `400` | 11.48ms | ✅ PASS |
...
// Response Body:
{
  "access_token": "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIxIiwidXNlcm5hbWUiOiJhZG1pbiIsInJvbGUiOiJBRE1JTiIsImV4cCI6MTc4NzU4MDQ0Nn0.OVyPhswdYtSNlyDogfA5EqxiFUu4mjaNmGc9sCa0WjM",
  "token_type": "bearer",
  "token": "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIxIiwidXNlcm5hbWUiOiJhZG1pbiIsInJvbGUiOiJBRE1JTiIsImV4cCI6MTc4NzU4MDQ0Nn0.OVyPhswdYtSNlyDogfA5EqxiFUu4mjaNmGc9sCa0WjM",
  "user": {
    "id": 1,
    "username": "admin",
...
[
  {
    ...
    "vai_tro": "USER",
    "trang_thai": "ACTIVE",
    "created_at": "2026-08-24T13:07:26",
    "updated_at": "2026-08-24T13:07:26"
  }
]
```
...
// Response Body:
{
  ...
  "vai_tro": "USER",
  "trang_thai": "ACTIVE",
  "created_at": "2026-08-24T13:07:27",
  "updated_at": "2026-08-24T13:07:27"
}
```
